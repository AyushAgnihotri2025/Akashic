...
const Body = () => {
  ...
  function updateInfo() {
    confirmAlert({
      ...
      afterClose: () => {dispatch({ type: "LOGOUT" }); navigate("/login/faculty");},
    });
  };
  ...
  useEffect(() => {
    if (store.errors || store.faculty.updatedFaculty) {
      ...
      if (store.faculty.updatedFaculty) {
        setError({});
        setValue({
          name: "",
          dob: "",
  ...
  return (
    <div className="flex-[0.8] mt-3 tablet:custom-added-8 mobile:custom-added-8 mobile:flex-[1] tablet:flex-[1] tablet:custom-added-8">
      <div className="space-y-5 mobile:custom-added-7 tablet:custom-added-7">
        ...
        <div className=" mr-10 bg-white flex flex-col rounded-xl mobile:custom-added-9 ">
