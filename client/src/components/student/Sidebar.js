            ...
            <ul className="space-y-2">
              ...
              <li>
                ...
                <ul id="dropdown-profile" className="hidden space-y-2 py-2">
                  <li>
                    <a href="/student/profile" className="group flex w-full items-center rounded-lg p-2 pl-11 text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View</a>
                  </li>
                  <li>
                    <a href="/student/update" className="group flex w-full items-center rounded-lg p-2 pl-11 text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Update Profile</a>
                  </li>
                  <li>
                    <a href="/student/update/password" className="group flex w-full items-center rounded-lg p-2 pl-11 text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Update Password</a>
                  </li>
                </ul>
              </li>
              <li>
                <a href="/student/testresult" className="flex items-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  ...
                  <span className="ml-3 flex-1 whitespace-nowrap">Test Results</span>
                </a>
              </li>
              <li>
                <a href="/student/attendance" className="flex items-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  <AddIcon className="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
                  <span className="ml-3 flex-1 whitespace-nowrap">Attendance</span>
                </a>
              </li>
              <li>
                <a href="/student/subjectlist" className="flex items-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  ...
                  <span className="ml-3 flex-1 whitespace-nowrap">Subject List</span>
                </a>
              </li>
              <li>
