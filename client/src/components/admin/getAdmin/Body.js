            ...
            {search &&
              ...
              admins?.length !== 0 && (
                <ol className={`${classes.adminData} custom-added-10 collection collection-container text-alignment`}>
                  <li className="item item-container item-container-admin">
                    ...
                    <div className="attribute-last" data-name="DOB">
                      D.O.B
                    </div>
                  </li>
                  {admins?.map((adm, idx) => (
                    <li
                      key={idx}
                      className="item item-container item-container-admin laptop:hover:scale-105 laptop:transition-all duration-150">
                      <div className="attribute" data-name="Sr no.">
                        {idx + 1}
                      </div>
                      <div className="attribute" data-name="Name">
